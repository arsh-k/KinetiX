...
collision_integrals_B_star = [
    [1.1852, 1.2963, 1.2963, 1.2963, 1.2963, 1.2963, 1.2963, 1.2963],
    [1.1960, 1.2160, 1.2370, 1.2690, 1.2850, 1.2900, 1.2970, 1.2940],
    [1.2451, 1.2570, 1.3400, 1.3890, 1.3660, 1.3270, 1.3140, 1.2780],
    [1.2900, 1.2940, 1.2720, 1.2580, 1.2620, 1.2820, 1.2900, 1.2990],
    [1.2986, 1.2910, 1.2840, 1.2780, 1.2770, 1.2880, 1.2940, 1.2970],
    [1.2865, 1.2810, 1.2760, 1.2720, 1.2770, 1.2860, 1.2920, 1.2980],
    [1.2665, 1.2640, 1.2610, 1.2630, 1.2690, 1.2840, 1.2920, 1.2980],
    [1.2455, 1.2440, 1.2480, 1.2550, 1.2620, 1.2780, 1.2890, 1.2960],
    [1.2253, 1.2250, 1.2340, 1.2400, 1.2520, 1.2710, 1.2840, 1.2950],
    [1.2078, 1.2100, 1.2160, 1.2270, 1.2420, 1.2640, 1.2810, 1.2920],
    [1.1919, 1.1920, 1.2050, 1.2160, 1.2300, 1.2560, 1.2730, 1.2870],
    [1.1678, 1.1720, 1.1810, 1.1950, 1.2090, 1.2370, 1.2610, 1.2770],
    [1.1496, 1.1550, 1.1610, 1.1740, 1.1890, 1.2210, 1.2460, 1.2660],
    [1.1366, 1.1410, 1.1470, 1.1590, 1.1740, 1.2020, 1.2310, 1.2560],
    [1.1270, 1.1300, 1.1380, 1.1480, 1.1620, 1.1910, 1.2180, 1.2420],
    [1.1197, 1.1220, 1.1290, 1.1400, 1.1490, 1.1780, 1.2050, 1.2310],
    [1.1080, 1.1100, 1.1160, 1.1220, 1.1320, 1.1540, 1.1800, 1.2050],
    [1.1016, 1.1030, 1.1070, 1.1120, 1.1200, 1.1380, 1.1600, 1.1830],
    [1.0980, 1.0990, 1.1020, 1.1060, 1.1120, 1.1270, 1.1450, 1.1650],
    [1.0958, 1.0970, 1.0990, 1.1020, 1.1070, 1.1190, 1.1350, 1.1530],
    [1.0935, 1.0940, 1.0950, 1.0970, 1.1000, 1.1090, 1.1200, 1.1340],
    [1.0925, 1.0920, 1.0940, 1.0950, 1.0980, 1.1040, 1.1120, 1.1220],
    [1.0922, 1.0920, 1.0930, 1.0940, 1.0960, 1.1000, 1.1060, 1.1150],
    [1.0922, 1.0920, 1.0930, 1.0930, 1.0950, 1.0980, 1.1030, 1.1100],
    [1.0923, 1.0920, 1.0930, 1.0930, 1.0940, 1.0970, 1.1010, 1.1060],
    [1.0923, 1.0920, 1.0920, 1.0930, 1.0940, 1.0960, 1.0990, 1.1030],
    [1.0927, 1.0930, 1.0930, 1.0930, 1.0940, 1.0950, 1.0980, 1.1010],
    [1.0930, 1.0930, 1.0930, 1.0930, 1.0940, 1.0940, 1.0960, 1.0990],
    [1.0933, 1.0940, 1.0930, 1.0940, 1.0940, 1.0950, 1.0960, 1.0980],
    [1.0937, 1.0930, 1.0940, 1.0940, 1.0940, 1.0940, 1.0960, 1.0970],
    [1.0939, 1.0940, 1.0940, 1.0940, 1.0940, 1.0950, 1.0950, 1.0970],
    [1.0943, 1.0940, 1.0940, 1.0940, 1.0950, 1.0950, 1.0960, 1.0960],
    [1.0944, 1.0950, 1.0940, 1.0940, 1.0940, 1.0950, 1.0950, 1.0960],
    [1.0944, 1.0940, 1.0950, 1.0940, 1.0940, 1.0950, 1.0960, 1.0960],
    [1.0943, 1.0950, 1.0940, 1.0940, 1.0950, 1.0950, 1.0950, 1.0950],
    [1.0941, 1.0940, 1.0940, 1.0940, 1.0940, 1.0940, 1.0940, 1.0960],
    [1.0947, 1.0950, 1.0940, 1.0940, 1.0930, 1.0930, 1.0940, 1.0950],
    [1.0957, 1.0950, 1.0940, 1.0930, 1.0920, 1.0930, 1.0930, 1.0940],
    [1.10185, 1.10185, 1.10185, 1.10185, 1.10185, 1.10185, 1.10185, 1.10185]
]

collision_integrals_C_star = [
